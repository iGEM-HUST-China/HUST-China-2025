...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/fatase-sdspage.webp" caption="Figure 1 LSDS-Page Result(from right to left lane : supernatant of po1f-WT,supernatant of Po1f-tll,supernatant of Po1f-tll,marker)" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hw2/12345.webp" caption="Figure 2 Different groups of different cultivation times " %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/growth-curve-wrong-vision.webp" caption="Figure 3 Growth curves without re-suspension of yeast" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/growth-curve-yousuan-1-1-3-5.webp" caption="Figure 4  Growth curves after improvement" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/growth-curve-ph-t.webp" caption="Figure 5 The growth curve under different cultivation conditions" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/mva-overexpression.webp" caption="Figure 6 oil extraction results(from left to right WT,FA,BO)" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/squalene-mva-po1f-fatase.webp" caption="Figure 7 suqalene content synthesis" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/squalene-thmgr-nadhhmgr-oil.webp" caption="Figure 8 suqalene content synthesis" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/qiao.webp" caption="Figure
9 results of ERG1-sg yeast" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/jiaotu1.webp" caption="Figure 10 ERG20-SKL，IDI-SKL PCR result" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/jiaotu2.webp" caption="Figure 11 ERG8-SKL，ERG9-SKL,ERG10-SKL PCR result" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hw2/movie9-soconvert-5.webp" caption="Figure 12 structure of re-design enzymes" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/pts1-gfp.webp" caption="Figure 13 Distribution of lipids and green fluorescent protein in engineered strains/Targeting of our peptide(SKL)
...
" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/pts1-vision1.webp" caption="Figure 14 signal peptide sifting" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/model/m1.webp" caption="Figure 15. improvement of signal peptide structures" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh4.webp" caption="Figure 16 design of version 2.0" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh5.webp" caption="Figure 17 design of version 2.0" %}
...
Reliability and control precision are key to productization. We recognized that while pursuing functional innovation, we must select components with matching performance and consider the mechanical strength of materials.
 {% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh6.webp" caption="Figure 18 design of version 3.0" %}
### Final Outcome (V4.0)
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hardware/h40.webp" caption="Figure 19  Overall Presentation Diagram" %}
