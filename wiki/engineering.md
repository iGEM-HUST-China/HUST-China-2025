...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/growth-curve-ph-t.webp" caption="Figure 5 Growth Curves at Different Temperatures and pH Levels" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/mva-overexpression.webp" caption="Figure 6 Comparison of Fatty Acid Degradation and Absorption" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/squalene-mva-po1f-fatase.webp" caption="Figure 7 Squalene production" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/en/squalene-thmgr-nadhhmgr-oil.webp" caption="Figure 8 Squalene yield following speed-limiting enzyme modification" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/qiao.webp" caption="Figure
9 Comparison of Growth Patterns Between Wild-Type and ERG Knockout Plants" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hw2/movie9-soconvert-5.webp" caption="Figure 12 Alignment of t-HMGR before and after optimization" %}
...
" %}
{% include figure.html image="https://static.igem.wiki/teams/5569/en/pts1-vision1.webp" caption="Figure 14 PEX5-ERG8 soft docing" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/model/m1.webp" caption="Figure 15. Molecular_docking" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh4.webp" caption="Figure 16 Schematic of the First-Generation Model" %}
...
{% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh5.webp" caption="Figure 17 Schematic of the Second Generation Model" %}
...
Reliability and control precision are key to productization. We recognized that while pursuing functional innovation, we must select components with matching performance and consider the mechanical strength of materials.
 {% include figure.html image="https://static.igem.wiki/teams/5569/hardware/hh6.webp" caption="Figure 18 Schematic of the Third-Generation Model" %}
### Final Outcome (V4.0)
