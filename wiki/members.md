...
{% include members-people.html 
   name="Zeyang Li" 
   description="As constant as the rivers' flow, as clear as limpid pools will show." 
   image="https://static.igem.wiki/teams/5175/resources/members/zeyang-li.webp" 
   image_position="left" %}
...
{% include members-people.html 
   name="Zhengdong Wu" 
   description="Not start unless completely prepared." 
   image="https://static.igem.wiki/teams/5175/resources/members/zhengdong-wu.webp" 
   image_position="right" %}

{% include members-people.html 
   name="Rui Zhu" 
   description="I'm perfectly lucid." 
...
{% include members-people.html
   ...
   image="https://static.igem.wiki/teams/5175/resources/members/wanting-zou.webp"
   image_position="left" %}

{% include members-people.html
   name="Xihong Zeng"
   description="To see the world as it is, and to love it."
   image="https://static.igem.wiki/teams/5175/resources/members/xihong-zeng.webp"
   image_position="right" %}

{% include members-people.html
   name="Xuhuan Ren"
   description="Youth is not a time of life; it is a state of mind; it is not a matter of rosy cheeks, red lips and supple knees; it is a matter of the will, a quality of the imagination, a vigor of the emotions; it is the freshness of the deep springs of life."
   image="https://static.igem.wiki/teams/5175/resources/members/xuhuan-ren.webp"
   image_position="left" %}
...
{% include members-people.html
   name="Yizhe Li"
   description="If not for true passion, how could we pursue biology"
   image="https://static.igem.wiki/teams/5175/resources/members/yizhe-li.webp"
   image_position="right" %}

{% include members-people.html
   name="Yuhan Huang"
   description="What's coming will come, and we'll meet it when it does."
   image="https://static.igem.wiki/teams/5175/resources/members/yuhan-huang.webp"
   image_position="left" %}

{% include members-people.html
   name="Yutong Bie"
   description="There is a crack in everything, that's how the light gets in."
   image="https://static.igem.wiki/teams/5175/resources/members/yutong-bie.webp"
   image_position="right" %}

{% include members-people.html
   name="Yuxuan Qi"
   description="The project that each team member worked hard on is the best, and hope for good results!"
   image="https://static.igem.wiki/teams/5175/resources/members/yuxuan-qi.webp"
   image_position="left" %}

{% include members-people.html
   name="Zihao Yang"
   description="Finally, tomorrow is another day. Everything changed, but everything remains unchanged. I wish I own the courage to start over whenever the path collapses."
   image="https://static.igem.wiki/teams/5175/resources/members/zihao-yang.webp"
   image_position="right" %}

{% include members-people.html
   name="Zilu Feng"
   description="It's my great honor to be involved in HUST-China,and my journey to the mysterious and dazzling biology world has just started."
   image="https://static.igem.wiki/teams/5175/resources/members/zilu-feng.webp"
   image_position="left" %}

{% include members-people.html
   name="Zixin Dong"
   description="I have to remind myself that some birds aren't meant to be caged,their feathers are just too bright."
   image="https://static.igem.wiki/teams/5175/resources/members/zixin-dong.webp"
   image_position="right" %}
